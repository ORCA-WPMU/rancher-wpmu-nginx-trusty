...
docker build --no-cache -t="stormerider/docker-wpmu-nginx:trusty.$DATE" .
echo ""
...
docker build --no-cache -t="stormerider/docker-wpmu-nginx:xenial.$DATE" . -f Dockerfile-xenial
echo ""
